...
module.exports = declare((api, options) => {
  ...
  if (typeof modules !== 'undefined' && typeof modules !== 'boolean' && modules !== 'auto') {
    throw new TypeError(
      'babel-preset-arcadia only accepts `true`, `false`, or `"auto"` as the value of the "modules" option'
    );
  }
  ...
  return {
    ...
    plugins: [
      ...
      isNode ? null : [require('@babel/plugin-proposal-object-rest-spread'), { useBuiltIns: true }],
